Clazz.declarePackage ("org.jmol.navigate");
Clazz.load (["org.jmol.api.JmolNavigatorInterface", "org.jmol.thread.JmolThread"], "org.jmol.navigate.Navigator", ["java.lang.Float", "org.jmol.util.Escape", "$.Hermite", "$.Point3f", "$.Vector3f"], function () {
...
}, org.jmol.navigate, "Navigator", org.jmol.thread.JmolThread, org.jmol.api.JmolNavigatorInterface);
...
break;
case 4160:
pt1 =  new org.jmol.util.Point3f ();
pt = o[2];
this.tm.transformPoint2 (pt, pt1);
...
pt = o[2];
this.tm.transformPoint2 (pt, pt1);
this.tm.navTranslatePercent (0, pt1.x, pt1.y);
this.viewer.moveUpdate (0);
return;
}this.tm.transformPoint2 (this.tm.navigationCenter, this.tm.navigationOffset);
var x = (o[2]).floatValue ();
var y = (o[3]).floatValue ();
...
case -2:
if (this.isNavTo) {
if (!Float.isNaN (this.xTrans) || !Float.isNaN (this.yTrans)) this.tm.navTranslatePercent (-1, this.xTrans, this.yTrans);
...
var fStep = Clazz.doubleToInt ((iStep + 1) / this.totalSteps);
...
this.tm.navTranslatePercent (-1, x, y);
...
this.centerStart = org.jmol.util.Point3f.newP (this.tm.navigationCenter);
...
if (this.isPathGuide) {
org.jmol.util.Hermite.getHermiteList (7, pathGuide[iPrev][0], pathGuide[pt][0], pathGuide[iNext][0], pathGuide[iNext2][0], pathGuide[iNext3][0], this.points, i * nPer, nPer + 1, true);
org.jmol.util.Hermite.getHermiteList (7, pathGuide[iPrev][1], pathGuide[pt][1], pathGuide[iNext][1], pathGuide[iNext2][1], pathGuide[iNext3][1], this.pointGuides, i * nPer, nPer + 1, true);
} else {
org.jmol.util.Hermite.getHermiteList (7, path[iPrev], path[pt], path[iNext], path[iNext2], path[iNext3], this.points, i * nPer, nPer + 1, true);
}}
...
function (e) {
Clazz.superCall (this, org.jmol.navigate.Navigator, "oops", [e]);
this.tm.navigating = false;
}, "Exception");
});
