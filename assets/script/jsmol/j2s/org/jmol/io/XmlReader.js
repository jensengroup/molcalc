...
Clazz.load (null, "org.jmol.io.XmlReader", ["java.lang.Character", "org.jmol.io.XmlUtil", "org.jmol.util.Escape", "$.Point3f", "$.StringXBuilder"], function () {
c$ = Clazz.decorateAsClass (function () {
this.br = null;
this.line = null;
Clazz.instantialize (this, arguments);
}, org.jmol.io, "XmlReader");
...
data = sb.toString ();
}return org.jmol.io.XmlReader.extractTag (data, tag, closer, withTag);
}, "~S,~S,~B,~B");
c$.extractTagOnly = Clazz.defineMethod (c$, "extractTagOnly", 
function (data, tag) {
return org.jmol.io.XmlReader.extractTag (data, "<" + tag + ">", "</" + tag + ">", false);
}, "~S,~S");
...
var pt = org.jmol.io.XmlReader.setNext (data, what, nexta, 1);
if (pt < 2 || (pt = org.jmol.io.XmlReader.setNext (data, "\"", nexta, 0)) < 2) return "";
var pt1 = org.jmol.io.XmlReader.setNext (data, "\"", nexta, -1);
return (pt1 <= 0 ? "" : data.substring (pt, pt1));
}, "~S,~S");
Clazz.defineMethod (c$, "getXmlPoint", 
function (data, key) {
var spt = org.jmol.io.XmlReader.getXmlAttrib (data, key).$replace ('(', '{').$replace (')', '}');
...
ipt += what.length;
next[0] = ipt + offset;
if (offset > 0 && ipt < data.length && data.charAt (ipt) != '=') return org.jmol.io.XmlReader.setNext (data, what, next, offset);
return next[0];
