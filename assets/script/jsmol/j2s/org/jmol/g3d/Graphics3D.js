...
t.setText (str, font3d == null ? this.currentFont : (this.currentFont = font3d), this.argbCurrent, org.jmol.util.Colix.isColixTranslucent (bgColix) ? (this.getColorArgbOrGray (bgColix) & 0xFFFFFF) | ((bgColix & 30720) << 13) : 0, xBaseline, yBaseline, z);
...
org.jmol.g3d.TextRenderer.plot (x, y, z, argb, bgargb, text, font3d, this, jmolRenderer, this.antialiasThisFrame);
...
if (bgargb != 0) {
org.jmol.g3d.Graphics3D.mergeBufferPixel (this.pbuf, offset, bgargb, this.bgcolor);
