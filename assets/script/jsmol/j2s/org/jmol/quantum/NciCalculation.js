...
this.rhoParam = org.jmol.quantum.NciCalculation.getParameter (parameters, 4, this.DEFAULT_RHOPARAM, "rhoParam");
this.dataScaling = org.jmol.quantum.NciCalculation.getParameter (parameters, 5, 1, "dataScaling");
...
org.jmol.util.Logger.info ("NCI calculation type = " + (this.isPromolecular ? "promolecular " : "SCF(CUBE) ") + stype);
...
org.jmol.util.Logger.info ("NCI calculation just setting nuclear charge for " + this.qmAtoms[i].atom + " to 18 (argon)");
}}
this.nMolecules = 0;
if (this.type != 0) {
...
org.jmol.util.Logger.info ("NCI calculation parameters[" + i + "] (" + name + ") = " + param);
return param;
...
org.jmol.util.Logger.info ("NCI calculation SCF " + (this.type == 1 ? "intra" : "inter") + "molecular grid points = " + this.bsOK.cardinality ());
...
this.isReducedDensity = false;
Clazz.superCall (this, org.jmol.quantum.NciCalculation, "initializeOnePoint", []);
});
...
if (isReducedDensity) {
s = org.jmol.quantum.NciCalculation.c * this.grad * Math.pow (rho, org.jmol.quantum.NciCalculation.rpower);
...
var ce1 = org.jmol.quantum.NciCalculation.coef1[znuc] * Math.exp (-r / z1);
var ce2 = org.jmol.quantum.NciCalculation.coef2[znuc] * Math.exp (-r / z2);
var ce3 = org.jmol.quantum.NciCalculation.coef3[znuc] * Math.exp (-r / z3);
