...
Clazz.load (["org.jmol.api.MepCalculationInterface", "org.jmol.quantum.QuantumCalculation"], "org.jmol.quantum.MepCalculation", ["java.io.BufferedInputStream", "$.ByteArrayInputStream", "java.lang.Float", "java.util.Hashtable", "org.jmol.io.JmolBinary", "org.jmol.util.Logger", "$.Parser"], function () {
...
org.jmol.util.Logger.error ("Exception " + e.toString () + " in getResource " + resourceName);
try {
br.close ();
} catch (ee) {
