...
Clazz.load (["org.jmol.api.ApiPlatform"], "org.jmol.awtjs2d.Platform", ["java.net.URL", "org.jmol.api.Interface", "org.jmol.awtjs2d.AjaxURLStreamHandlerFactory", "$.Display", "$.Font", "$.Image", "$.JmolFile", "$.JmolFileAdapter", "$.Mouse"], function () {
...
var jmolpopup = org.jmol.api.Interface.getOptionInterface (c);
try {
...
return (canvas.buf32 ? canvas.buf32 
  : canvas.buf32 = org.jmol.awtjs2d.Image.grabPixels (org.jmol.awtjs2d.Image.getGraphics (canvas), width, height));
}, "~O,~N,~N,~A,~N,~N");
