...
org.jmol.util.Logger.warn ("not enough surfaces in file -- resetting params.fileIndex to " + this.nSurfaces);
...
if (!this.vertexDataOnly) org.jmol.util.Logger.info ("JVXL read: " + this.nPointsX + " x " + this.nPointsY + " x " + this.nPointsZ + " data points");
return true;
}, "~B");
...
org.jmol.util.Logger.info ("downsampling axis " + (i + 1) + " from " + n + " to " + this.voxelCounts[i]);
}
}for (var i = 0; i < 3; ++i) {
...
var plane = Clazz.superCall (this, org.jmol.jvxl.readers.VolumeFileReader, "getPlane", [x]);
...
var plane;
if (this.iPlaneRaw == 0) {
this.qpc = org.jmol.api.Interface.getOptionInterface ("quantum.NciCalculation");
var atomData =  new org.jmol.atomdata.AtomData ();
...
}return Clazz.superCall (this, org.jmol.jvxl.readers.VolumeFileReader, "getValue", [x, y, z, ptyz]);
}, "~N,~N,~N,~N");
...
var atomCount = (strAtomCount == null ? 2147483647 : org.jmol.util.Parser.parseInt (strAtomCount));
switch (atomCount) {
case -2147483648:
atomCount = 0;
