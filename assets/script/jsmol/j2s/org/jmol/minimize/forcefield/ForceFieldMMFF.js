...
function () {
return org.jmol.minimize.forcefield.ForceFieldMMFF.getAtomTypeDescs (this.rawAtomTypes);
});
...
function (m) {
Clazz.superConstructor (this, org.jmol.minimize.forcefield.ForceFieldMMFF, []);
this.minimizer = m;
this.name = "MMFF";
...
var m = this.minimizer;
this.vRings = org.jmol.util.ArrayUtil.createArrayOfArrayList (4);
this.rawAtomTypes = org.jmol.minimize.forcefield.ForceFieldMMFF.setAtomTypes (atoms, bsAtoms, m.viewer.getSmilesMatcher (), this.vRings, allowUnknowns);
...
switch (dataType) {
case 546:
value = [Double.$valueOf (line.substring (19, 25).trim ()).doubleValue (), Double.$valueOf (line.substring (13, 18).trim ()).doubleValue ()];
break;
case 3:
value = [Double.$valueOf (line.substring (14, 20).trim ()).doubleValue (), Double.$valueOf (line.substring (25, 31).trim ()).doubleValue ()];
break;
case 5:
case 21:
value = [Double.$valueOf (line.substring (19, 25).trim ()).doubleValue (), Double.$valueOf (line.substring (28, 35).trim ()).doubleValue ()];
break;
case 34:
value = Float.$valueOf (line.substring (10, 20).trim ());
break;
case 13:
value = [Double.$valueOf (line.substring (24, 30).trim ()).doubleValue ()];
break;
case 1:
value = Float.$valueOf (line.substring (5, 15).trim ());
break;
case 37:
var v1 = Double.$valueOf (line.substring (19, 25).trim ()).doubleValue ();
var v2 = Double.$valueOf (line.substring (28, 35).trim ()).doubleValue ();
value = [v1, v2];
var key = org.jmol.minimize.MinObject.getKey (type, a1, a2, a3, a4);
data.put (key, value);
value = [v2, v1];
var a = a1;
a1 = a3;
...
break;
case 9:
value = [Double.$valueOf (line.substring (22, 28).trim ()).doubleValue (), Double.$valueOf (line.substring (30, 36).trim ()).doubleValue (), Double.$valueOf (line.substring (38, 44).trim ()).doubleValue ()];
break;
case 17:
value = [Double.$valueOf (line.substring (10, 15).trim ()).doubleValue (), Double.$valueOf (line.substring (20, 25).trim ()).doubleValue (), Double.$valueOf (line.substring (30, 35).trim ()).doubleValue (), Double.$valueOf (line.substring (40, 45).trim ()).doubleValue (), line.charAt (46)];
break;
}
var key = org.jmol.minimize.MinObject.getKey (type, a1, a2, a3, a4);
data.put (key, value);
if (org.jmol.util.Logger.debugging) org.jmol.util.Logger.info (org.jmol.minimize.MinObject.decodeKey (key) + " " + org.jmol.util.Escape.escape (value));
}
br.close ();
} catch (e) {
...
var val = Integer.$valueOf (line.substring (16, 18).trim ()).intValue ();
var desc = line.substring (19, 44).trim ();
var smarts = line.substring (45).trim ();
types.add (at =  new org.jmol.minimize.forcefield.AtomType (elemNo, mmType, hType, formalCharge, val, desc, smarts));
org.jmol.minimize.forcefield.ForceFieldMMFF.setFlags (at);
}
br.close ();
} catch (e) {
if (Clazz.exceptionOf (e, Exception)) {
...
var key = org.jmol.minimize.MinObject.getKey (bondType, bFactor == 1 ? type2 : type1, bFactor == 1 ? type1 : type2, 127, 124);
var bciValue = org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (key);
var bci;
var msg = (org.jmol.util.Logger.debugging ? a1 + "/" + a2 + " mmTypes=" + type1 + "/" + type2 + " formalCharges=" + at1.formalCharge + "/" + at2.formalCharge + " bci = " : null);
if (bciValue == null) {
var pa = (org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (org.jmol.minimize.MinObject.getKey (0, type1, 127, 127, 127))).floatValue ();
var pb = (org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (org.jmol.minimize.MinObject.getKey (0, type2, 127, 127, 127))).floatValue ();
bci = pa - pb;
if (org.jmol.util.Logger.debugging) msg += pa + " - " + pb + " = ";
} else {
bci = bFactor * bciValue.floatValue ();
}if (org.jmol.util.Logger.debugging) {
msg += bci;
org.jmol.util.Logger.debug (msg);
...
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.forcefield.AtomType,org.jmol.minimize.forcefield.AtomType");
Clazz.defineMethod (c$, "getBondType", 
($fz = function (bond, at1, at2, index1, index2) {
return (org.jmol.minimize.forcefield.ForceFieldMMFF.isBondType1 (at1, at2) && bond.getCovalentOrder () == 1 && !this.isAromaticBond (index1, index2) ? 1 : 0);
}, $fz.isPrivate = true, $fz), "org.jmol.modelset.Bond,org.jmol.minimize.forcefield.AtomType,org.jmol.minimize.forcefield.AtomType,~N,~N");
...
stypes[i] = String.valueOf (types[i] < 0 ? -types[i] : org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (types[i]).mmType);
}
return stypes;
}, "~A");
...
if (j != 0) bsDone.set (i);
types[i] = -org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (j).hType;
}}
if (org.jmol.util.Logger.debugging) for (var i = bsConnected.nextSetBit (0); i >= 0; i = bsConnected.nextSetBit (i + 1)) org.jmol.util.Logger.info ("atom " + atoms[i] + "\ttype " + (types[i] < 0 ? "" + -types[i] : (org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (types[i]).mmType + "\t" + org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (types[i]).smartsCode + "\t" + org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (types[i]).descr)));
...
a.ffAtomType = org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (Math.max (0, it));
var type = (it < 0 ? -it : org.jmol.minimize.forcefield.ForceFieldMMFF.atomTypes.get (it).mmType);
a.ffType = type;
a.vdwKey = org.jmol.minimize.MinObject.getKey (0, type, 127, 127, 122);
...
}angle.sbType = org.jmol.minimize.forcefield.ForceFieldMMFF.sbMap[angle.type];
switch (angle.type) {
case 1:
case 5:
case 7:
...
return angle.type;
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.MinAngle");
...
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.MinTorsion");
...
return false;
}, $fz.isPrivate = true, $fz), "java.util.List,~A,~N");
...
break;
case 5:
if (this.fixOrder (data, 0, 2) == -1) org.jmol.minimize.forcefield.ForceFieldMMFF.swap (data, 3, 4);
...
break;
case -1:
org.jmol.minimize.forcefield.ForceFieldMMFF.swap (data, 0, 3);
org.jmol.minimize.forcefield.ForceFieldMMFF.swap (data, 4, 6);
break;
case 0:
if (this.fixOrder (data, 0, 3) == -1) org.jmol.minimize.forcefield.ForceFieldMMFF.swap (data, 4, 6);
break;
}
...
break;
case 13:
org.jmol.minimize.forcefield.ForceFieldMMFF.sortOop (this.typeData);
break;
}
key = org.jmol.minimize.MinObject.getKey (type, this.typeData[0], this.typeData[1], this.typeData[2], this.typeData[3]);
var ddata = org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (key);
switch (ktype) {
case 3:
...
case 9:
if (ddata == null) {
if (!org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.containsKey (key = this.getTorsionKey (type, 0, 2)) && !org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.containsKey (key = this.getTorsionKey (type, 2, 0)) && !org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.containsKey (key = this.getTorsionKey (type, 2, 2))) key = this.getTorsionKey (0, 2, 2);
ddata = org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (key);
}if (!this.useEmpiricalRules) return key;
...
return org.jmol.minimize.MinObject.getKey (0, r1, r2, r3, 126);
case 13:
if (ddata != null) return key;
}
...
for (var j = 0, bit = 1; j < n; j++, bit <<= 1) if ((ktype & bit) == bit) this.typeData[j] = org.jmol.minimize.forcefield.ForceFieldMMFF.getEquivalentType (this.typeOf (data[j]), i);

switch (ktype) {
case 3:
isSwapped = (org.jmol.minimize.forcefield.ForceFieldMMFF.fixTypeOrder (this.typeData, 0, 1));
break;
case 5:
isSwapped = (org.jmol.minimize.forcefield.ForceFieldMMFF.fixTypeOrder (this.typeData, 0, 2));
break;
case 13:
org.jmol.minimize.forcefield.ForceFieldMMFF.sortOop (this.typeData);
break;
...
key = org.jmol.minimize.MinObject.getKey (type, this.typeData[0], this.typeData[1], this.typeData[2], this.typeData[3]);
haveKey = org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.containsKey (key);
}
if (haveKey) {
if (isSwapped) switch (ktype) {
case 5:
org.jmol.minimize.forcefield.ForceFieldMMFF.swap (data, 0, 2);
org.jmol.minimize.forcefield.ForceFieldMMFF.swap (data, 3, 4);
this.setAngleType (o);
break;
}
...
return org.jmol.minimize.MinObject.getKey (type, org.jmol.minimize.forcefield.ForceFieldMMFF.getEquivalentType (this.typeData[0], i), this.typeData[1], this.typeData[2], org.jmol.minimize.forcefield.ForceFieldMMFF.getEquivalentType (this.typeData[3], j));
...
var key = org.jmol.minimize.MinObject.getKey (0, Math.min (elemno1, elemno2), Math.max (elemno1, elemno2), 127, 123);
ddata = org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (key);
if (ddata == null) return null;
var kbref = ddata[0];
var r0ref = ddata[1];
var r0 = org.jmol.minimize.forcefield.ForceFieldMMFF.getRuleBondLength (a, b, (o).order, this.isAromaticBond (o.data[0], o.data[1]));
if (r0 == 0) return null;
rr = r0ref / r0;
rr2 = rr * rr;
var rr4 = rr2 * rr2;
...
switch (crd) {
case 2:
if (org.jmol.minimize.MinAtom.isLinear (b)) theta0 = 180;
...
var za = org.jmol.minimize.forcefield.ForceFieldMMFF.getZParam (this.minAtoms[o.data[0]].atom.getElementNumber ());
var cb = org.jmol.minimize.forcefield.ForceFieldMMFF.getCParam (this.minAtoms[o.data[1]].atom.getElementNumber ());
var zc = org.jmol.minimize.forcefield.ForceFieldMMFF.getZParam (this.minAtoms[o.data[2]].atom.getElementNumber ());
var r0ab = org.jmol.minimize.forcefield.ForceFieldMMFF.getR0 (this.minBonds[o.data[3]]);
var r0bc = org.jmol.minimize.forcefield.ForceFieldMMFF.getR0 (this.minBonds[o.data[4]]);
rr = r0ab + r0bc;
rr2 = rr * rr;
var D = (r0ab - r0bc) / rr2;
...
b = this.minAtoms[ib];
c = this.minAtoms[ic];
if (org.jmol.minimize.MinAtom.isLinear (b) || org.jmol.minimize.MinAtom.isLinear (c)) return null;
var bondBC = this.minBonds[o.data[5]];
var elemnoB = b.atom.getElementNumber ();
var elemnoC = c.atom.getElementNumber ();
var ub = org.jmol.minimize.forcefield.ForceFieldMMFF.getUParam (elemnoB);
var uc = org.jmol.minimize.forcefield.ForceFieldMMFF.getUParam (elemnoC);
var vb = org.jmol.minimize.forcefield.ForceFieldMMFF.getVParam (elemnoB);
var vc = org.jmol.minimize.forcefield.ForceFieldMMFF.getVParam (elemnoC);
var v1 = 0;
var v2 = 0;
var v3 = 0;
var pi_bc = -1;
...
if (crdB == 4 && crdC == 4) {
vb = org.jmol.minimize.forcefield.ForceFieldMMFF.getVParam (elemnoB);
vc = org.jmol.minimize.forcefield.ForceFieldMMFF.getVParam (elemnoC);
n_bc = 9;
break out;
...
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.MinObject,~A,~N");
c$.getR0 = Clazz.defineMethod (c$, "getR0", 
($fz = function (b) {
return (b.ddata == null ? (org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (b.key)) : b.ddata)[1];
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.MinBond");
...
function (data) {
var ddata = org.jmol.minimize.forcefield.ForceFieldMMFF.ffParams.get (this.getKey (data, 6, 13));
return (ddata == null ? 0 : ddata[0]);
}, "~A");
c$.sortOop = Clazz.defineMethod (c$, "sortOop", 
($fz = function (typeData) {
org.jmol.minimize.forcefield.ForceFieldMMFF.fixTypeOrder (typeData, 0, 2);
org.jmol.minimize.forcefield.ForceFieldMMFF.fixTypeOrder (typeData, 0, 3);
org.jmol.minimize.forcefield.ForceFieldMMFF.fixTypeOrder (typeData, 2, 3);
}, $fz.isPrivate = true, $fz), "~A");
c$.fixTypeOrder = Clazz.defineMethod (c$, "fixTypeOrder", 
($fz = function (a, i, j) {
if (a[i] > a[j]) {
org.jmol.minimize.forcefield.ForceFieldMMFF.swap (a, i, j);
return true;
}return false;
...
if (test < 0) org.jmol.minimize.forcefield.ForceFieldMMFF.swap (a, i, j);
...
return (type == 0 ? 0 : type == 70 || type > 82 ? type : level == 2 ? 0 : org.jmol.minimize.forcefield.ForceFieldMMFF.equivalentTypes[((type - 1) << 1) + level]);
}, $fz.isPrivate = true, $fz), "~N,~N");
...
return 1.55;
default:
return org.jmol.util.Elements.getBondingRadiusFloat (elemno, 0);
}
}, $fz.isPrivate = true, $fz), "~N");
...
var elemnoB = b.atom.getElementNumber ();
var r0a = org.jmol.minimize.forcefield.ForceFieldMMFF.getCovalentRadius (elemnoA);
var r0b = org.jmol.minimize.forcefield.ForceFieldMMFF.getCovalentRadius (elemnoB);
var Xa = org.jmol.util.Elements.getAllredRochowElectroNeg (elemnoA);
var Xb = org.jmol.util.Elements.getAllredRochowElectroNeg (elemnoB);
...
case 1:
case 2:
red += org.jmol.minimize.forcefield.ForceFieldMMFF.r0reductions[1];
break;
case 3:
red += org.jmol.minimize.forcefield.ForceFieldMMFF.r0reductions[0];
break;
}
...
break;
default:
red += 2 * org.jmol.minimize.forcefield.ForceFieldMMFF.r0reductions[boAB];
break;
}
r -= c * Math.pow (Math.abs (Xa - Xb), n);
return r;
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.MinAtom,org.jmol.minimize.MinAtom,~N,~B");
