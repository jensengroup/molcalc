...
this.sbCalc = null;
this.mmff = null;
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.DistanceCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$DistanceCalc$ ();
}
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.AngleCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$AngleCalc$ ();
}
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.SBCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$SBCalc$ ();
}
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.TorsionCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$TorsionCalc$ ();
}
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.OOPCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$OOPCalc$ ();
}
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.VDWCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$VDWCalc$ ();
}
if (!Clazz.isClassDefined ("org.jmol.minimize.forcefield.CalculationsMMFF.ESCalc")) {
org.jmol.minimize.forcefield.CalculationsMMFF.$CalculationsMMFF$ESCalc$ ();
}
Clazz.instantialize (this, arguments);
}, org.jmol.minimize.forcefield, "CalculationsMMFF", org.jmol.minimize.forcefield.Calculations);
Clazz.makeConstructor (c$, 
function (ff, ffParams, minAtoms, minBonds, minAngles, minTorsions, constraints) {
Clazz.superConstructor (this, org.jmol.minimize.forcefield.CalculationsMMFF, [ff, minAtoms, minBonds, minAngles, minTorsions, constraints]);
this.mmff = ff;
this.ffParams = ffParams;
this.bondCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.DistanceCalc, this, null);
this.angleCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.AngleCalc, this, null);
this.sbCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.SBCalc, this, null);
this.torsionCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.TorsionCalc, this, null);
this.oopCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.OOPCalc, this, null);
this.vdwCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.VDWCalc, this, null);
this.esCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.ESCalc, this, null);
...
function () {
var calc;
var distanceCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.DistanceCalc, this, null);
...
var angleCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.AngleCalc, this, null);
for (var i = 0; i < this.angleCount; i++) angleCalc.setData (calc, this.minAngles[i]);

calc = this.calculations[2] =  new java.util.ArrayList ();
var sbCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.SBCalc, this, null);
for (var i = 0; i < this.angleCount; i++) sbCalc.setData (calc, this.minAngles[i]);

calc = this.calculations[3] =  new java.util.ArrayList ();
var torsionCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.TorsionCalc, this, null);
...
var oopCalc = Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.OOPCalc, this, null);
for (var i = 0; i < this.atomCount; i++) if (org.jmol.minimize.forcefield.CalculationsMMFF.isInvertible (this.minAtoms[i])) oopCalc.setData (calc, i);

this.pairSearch (this.calculations[5] =  new java.util.ArrayList (), Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.VDWCalc, this, null), this.calculations[6] =  new java.util.ArrayList (), Clazz.innerTypeInstance (org.jmol.minimize.forcefield.CalculationsMMFF.ESCalc, this, null));
return true;
});
Clazz.defineMethod (c$, "isLinear", 
function (i) {
return org.jmol.minimize.MinAtom.isLinear (this.minAtoms[i]);
}, "~N");
...
}, $fz.isPrivate = true, $fz), "org.jmol.minimize.MinAtom");
...
default:
return Clazz.superCall (this, org.jmol.minimize.forcefield.CalculationsMMFF, "getDebugHeader", [iType]);
}
}, "~N");
...
this.delta2 = 0;
Clazz.instantialize (this, arguments);
}, org.jmol.minimize.forcefield.CalculationsMMFF, "DistanceCalc", org.jmol.minimize.forcefield.Calculation);
...
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].setPairVariables (this);
...
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].gradients) {
this.dE = 71.96625 * this.kb * this.delta * (2 + 3 * -2.0 * this.delta + 4 * 2.3333333333333335 * this.delta2);
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 2);
}if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (0, this));
return this.energy;
}, "~A");
...
var b = this.dData[0];
var c = this.dData[1];
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].setAngleVariables (this);
var d = (this.theta * 57.29577951308232 - c);
if (c == 180) {
this.energy = 143.9325 * b * (1 + Math.cos (this.theta));
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].gradients) this.dE = -143.9325 * b * Math.sin (this.theta);
} else {
this.energy = 0.021922 * b * Math.pow (d, 2) * (1 + -0.006981317007977318 * d);
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].gradients) this.dE = 0.021922 * b * d * (2 + 3 * -0.006981317007977318 * d);
}if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].gradients) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 3);
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (1, this));
return this.energy;
}, "~A");
Clazz.defineStatics (c$,
...
var h = e[1];
var i = f[1];
a.add ([b.data, [c[0], g, h]]);
a.add ([[b.data[2], b.data[1], b.data[0]], [c[1], g, i]]);
}, "java.util.List,org.jmol.minimize.MinAngle");
Clazz.overrideMethod (c$, "compute", 
function (a) {
this.getPointers (a);
...
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (2, this));
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].gradients) {
this.dE = b * e;
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 3);
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].setPairVariables (this);
...
var c = this.dData[1];
var d = this.dData[2];
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].setTorsionVariables (this);
...
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 4);
}if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (3, this));
return this.energy;
}, "~A");
c$ = Clazz.p0p ();
};
...
a.add ([[c[2], b, c[0], c[1]], e]);
}, "java.util.List,~N");
Clazz.overrideMethod (c$, "compute", 
function (a) {
this.getPointers (a);
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].setOopVariables (this, false);
var b = this.dData[0];
this.energy = 71.96568080495746 * b * this.theta * this.theta;
if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].gradients) {
this.dE = 2.5120761569715815 * b * this.theta;
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 4);
}if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (4, this));
return this.energy;
}, "~A");
Clazz.defineStatics (c$,
...
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
}, org.jmol.minimize.forcefield.CalculationsMMFF, "VDWCalc", org.jmol.minimize.forcefield.Calculations.PairCalc, null, Clazz.innerTypeInstance (org.jmol.minimize.forcefield.Calculations.PairCalc, this, null, Clazz.inheritArgs));
Clazz.overrideMethod (c$, "setData", 
function (a, b, c) {
this.a = this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].minAtoms[b];
...
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 2);
}if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging && Math.abs (this.energy) > 0.1) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (5, this));
return this.energy;
}, "~A");
c$ = Clazz.p0p ();
};
...
this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].addForces (this, 2);
}if (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].logging && Math.abs (this.energy) > 20) this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].appendLogData (this.b$["org.jmol.minimize.forcefield.CalculationsMMFF"].getDebugLine (6, this));
return this.energy;
}, "~A");
Clazz.defineStatics (c$,
"BUFF", 0.05);
