...
}, org.jmol.adapter.readers.simple, "MopacReader", org.jmol.adapter.smarter.AtomSetCollectionReader);
...
if (this.line.indexOf ("2009") >= 0) this.mopacVersion = 2009;
 ...
 else if (this.line.indexOf ("MOPAC2") >= 0) this.mopacVersion = org.jmol.util.Parser.parseInt (this.line.substring (this.line.indexOf ("MOPAC2") + 5));
}
org.jmol.util.Logger.info ("MOPAC version " + this.mopacVersion);
});
...
if (Float.isNaN (org.jmol.util.Parser.parseFloatStrict (tokens[tokens.length - 1]))) {
this.discardLinesUntilNonBlank ();
tokens = this.getTokens ();
