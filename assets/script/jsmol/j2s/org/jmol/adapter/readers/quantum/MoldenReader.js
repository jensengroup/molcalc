...
($fz = function () {
var coordUnit = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.line.$replace (']', ' '))[1];
var nPrevAtom = 0;
var nCurAtom = 0;
...
var type = org.jmol.api.JmolAdapter.getQuantumShellTagID (shellLabel);
...
org.jmol.util.Logger.info (this.nCoef + " MO coefficients expected for orbital type " + this.orbitalType);
...
org.jmol.util.Logger.info ("too few orbital coefficients for 6D");
this.orbitalType = "[5D]";
this.fixOrbitalType ();
