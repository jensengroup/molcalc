...
this.readLine ();
if (this.line == null) {
org.jmol.util.Logger.warn ("$HDR not found in MDL RG file");
...
Clazz.superCall (this, org.jmol.adapter.readers.molxyz.MolReader, "finalizeReader", []);
});
...
this.atomSetCollection.addBond ( new org.jmol.adapter.smarter.Bond (atom0 + atomIndex1 - 1, atom0 + atomIndex2 - 1, order));
}
}, "~N,~N");
});
