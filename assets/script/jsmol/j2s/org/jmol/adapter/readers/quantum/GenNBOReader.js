...
}, org.jmol.adapter.readers.quantum, "GenNBOReader", org.jmol.adapter.readers.quantum.MOReader);
...
Clazz.superCall (this, org.jmol.adapter.readers.quantum.GenNBOReader, "initializeReader", []);
...
switch (n) {
case 1:
slater[1] = org.jmol.api.JmolAdapter.SHELL_S;
break;
case 3:
if (!this.getDFMap (this.line, org.jmol.api.JmolAdapter.SHELL_P, org.jmol.adapter.readers.quantum.GenNBOReader.$P_LIST, 3)) return false;
slater[1] = org.jmol.api.JmolAdapter.SHELL_P;
break;
case 4:
if (!this.getDFMap (this.line, org.jmol.api.JmolAdapter.SHELL_SP, org.jmol.adapter.readers.quantum.GenNBOReader.SP_LIST, 1)) return false;
slater[1] = org.jmol.api.JmolAdapter.SHELL_SP;
break;
case 5:
if (!this.getDFMap (this.line, org.jmol.api.JmolAdapter.SHELL_D_SPHERICAL, org.jmol.adapter.readers.quantum.GenNBOReader.$DS_LIST, 3)) return false;
slater[1] = org.jmol.api.JmolAdapter.SHELL_D_SPHERICAL;
break;
case 6:
if (!this.getDFMap (this.line, org.jmol.api.JmolAdapter.SHELL_D_CARTESIAN, org.jmol.adapter.readers.quantum.GenNBOReader.$DC_LIST, 3)) return false;
slater[1] = org.jmol.api.JmolAdapter.SHELL_D_CARTESIAN;
break;
case 7:
if (!this.getDFMap (this.line, org.jmol.api.JmolAdapter.SHELL_F_SPHERICAL, org.jmol.adapter.readers.quantum.GenNBOReader.$FS_LIST, 3)) return false;
slater[1] = org.jmol.api.JmolAdapter.SHELL_F_SPHERICAL;
break;
case 10:
if (!this.getDFMap (this.line, org.jmol.api.JmolAdapter.SHELL_F_CARTESIAN, org.jmol.adapter.readers.quantum.GenNBOReader.$FC_LIST, 3)) return false;
slater[1] = org.jmol.api.JmolAdapter.SHELL_F_CARTESIAN;
break;
}
...
org.jmol.util.Logger.debug (this.shells.size () + " slater shells read");
org.jmol.util.Logger.debug (this.gaussians.length + " gaussian primitives read");
}return true;
...
tokens = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.discardLinesUntilContains ("BETA"));
this.alphaBeta = "beta";
} else {
this.alphaBeta = "alpha";
this.haveNboOrbitals = true;
}}if (this.parseIntStr (tokens[ipt]) != this.nOrbitals) {
org.jmol.util.Logger.error ("file 46 number of orbitals does not match nOrbitals: " + this.nOrbitals);
return false;
}var ntype = null;
...
tokens = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (sb.toString ());
