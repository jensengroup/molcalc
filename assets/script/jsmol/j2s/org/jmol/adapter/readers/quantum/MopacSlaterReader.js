...
}, org.jmol.adapter.readers.quantum, "MopacSlaterReader", org.jmol.adapter.readers.quantum.SlaterReader);
...
if (ex >= 0 && ey >= 0) {
return Clazz.superCall (this, org.jmol.adapter.readers.quantum.MopacSlaterReader, "scaleSlater", [ex, ey, ez, er, zeta]);
}var el = Math.abs (ex + ey + ez);
if (el == 3) {
return 0;
}return org.jmol.adapter.readers.quantum.SlaterReader.getSlaterConstDSpherical (el + er + 1, Math.abs (zeta), ex, ey);
}, "~N,~N,~N,~N,~N");
c$.getNPQ = Clazz.defineMethod (c$, "getNPQ", 
($fz = function (atomicNumber) {
return (atomicNumber < org.jmol.adapter.readers.quantum.MopacSlaterReader.principalQuantumNumber.length ? org.jmol.adapter.readers.quantum.MopacSlaterReader.principalQuantumNumber[atomicNumber] : 0);
}, $fz.isPrivate = true, $fz), "~N");
c$.getNPQs = Clazz.defineMethod (c$, "getNPQs", 
($fz = function (atomicNumber) {
var n = org.jmol.adapter.readers.quantum.MopacSlaterReader.getNPQ (atomicNumber);
switch (atomicNumber) {
case 10:
case 18:
case 36:
...
($fz = function (atomicNumber) {
return (atomicNumber < org.jmol.adapter.readers.quantum.MopacSlaterReader.npqd.length ? org.jmol.adapter.readers.quantum.MopacSlaterReader.npqd[atomicNumber] : 0);
}, $fz.isPrivate = true, $fz), "~N");
