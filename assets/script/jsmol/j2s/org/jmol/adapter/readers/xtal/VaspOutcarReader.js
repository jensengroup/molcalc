...
($fz = function () {
this.atomSetCollection.setAtomSetName ("Temp. = " + org.jmol.util.TextFormat.formatDecimal ((this.temp), 2) + " K, Energy = " + this.totEne + " eV");
...
this.atomSetCollection.setAtomSetAuxiliaryInfo ("Temperature", org.jmol.util.TextFormat.formatDecimal ((this.temp), 2));
this.atomSetCollection.setAtomSetCollectionAuxiliaryInfo ("Temperature", org.jmol.util.TextFormat.formatDecimal ((this.temp), 2));
}, $fz.isPrivate = true, $fz));
