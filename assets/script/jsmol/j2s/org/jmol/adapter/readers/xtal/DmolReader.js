...
}, org.jmol.adapter.readers.xtal, "DmolReader", org.jmol.adapter.smarter.AtomSetCollectionReader);
...
this.atomSetCollection.setAtomSetName (org.jmol.util.TextFormat.formatDecimal (frequencies[i], 2) + " cm-1");
}
this.readLine ();
