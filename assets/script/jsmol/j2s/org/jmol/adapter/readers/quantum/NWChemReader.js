...
}, org.jmol.adapter.readers.quantum, "NWChemReader", org.jmol.adapter.readers.quantum.MOReader);
...
($fz = function () {
var tokens = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.readLines (3));
...
this.atomSetCollection.setAtomSetModelProperty (".PATH", "Task " + this.taskNumber + (this.inInput ? org.jmol.adapter.smarter.SmarterJmolAdapter.PATH_SEPARATOR + "Input" : org.jmol.adapter.smarter.SmarterJmolAdapter.PATH_SEPARATOR + "Geometry"));
this.atomTypes =  new java.util.ArrayList ();
...
this.atomSetCollection.setAtomSetModelProperty (".PATH", "Task " + this.taskNumber + org.jmol.adapter.smarter.SmarterJmolAdapter.PATH_SEPARATOR + "Gradients");
while (this.readLine () != null && this.line.length > 0) {
tokens = this.getTokens ();
...
var path = "Task " + this.taskNumber + org.jmol.adapter.smarter.SmarterJmolAdapter.PATH_SEPARATOR + "Frequencies";
...
tokens = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensAt (this.line, 12);
...
if (isD6F10) {
this.getDFMap (org.jmol.adapter.readers.quantum.NWChemReader.$DC_LIST, org.jmol.api.JmolAdapter.SHELL_D_CARTESIAN, org.jmol.adapter.readers.quantum.BasisFunctionReader.CANONICAL_DC_LIST, 3);
this.getDFMap (org.jmol.adapter.readers.quantum.NWChemReader.$FC_LIST, org.jmol.api.JmolAdapter.SHELL_F_CARTESIAN, org.jmol.adapter.readers.quantum.BasisFunctionReader.CANONICAL_FC_LIST, 3);
} else {
this.getDFMap (org.jmol.adapter.readers.quantum.NWChemReader.$DS_LIST, org.jmol.api.JmolAdapter.SHELL_D_SPHERICAL, org.jmol.adapter.readers.quantum.BasisFunctionReader.CANONICAL_DS_LIST, 2);
this.getDFMap (org.jmol.adapter.readers.quantum.NWChemReader.$FS_LIST, org.jmol.api.JmolAdapter.SHELL_F_SPHERICAL, org.jmol.adapter.readers.quantum.BasisFunctionReader.CANONICAL_FS_LIST, 2);
...
atomData =  new java.util.ArrayList ();
...
for (var ifunc = 0; ifunc < nGaussians; ifunc++) gdata.add (shellData.get (ifunc)[1]);
...
Clazz.defineMethod (c$, "readMolecularOrbitalAnalysis", 
($fz = function (doClear) {
...
Clazz.defineMethod (c$, "readMolecularOrbitalVectors", 
($fz = function () {
if (this.shells == null) return true;
var mos = null;
var data = null;
...
while (this.readLine () != null && this.line.length > 0) for (var i = 0, pt = ptOffset; i < nThisLine; i++, pt += fieldSize) data[i].add (this.line.substring (pt, pt + fieldSize).trim ());
...
function () {
Clazz.superCall (this, org.jmol.adapter.readers.quantum.NWChemReader, "readLine", []);
