...
Clazz.load (["org.jmol.adapter.readers.quantum.MOReader"], "org.jmol.adapter.readers.quantum.JaguarReader", ["java.lang.Boolean", "$.Float", "java.util.ArrayList", "$.Hashtable", "org.jmol.api.JmolAdapter", "org.jmol.util.ArrayUtil", "$.Logger"], function () {
c$ = Clazz.decorateAsClass (function () {
this.moCount = 0;
this.lumoEnergy = 3.4028235E38;
this.haveLine = false;
Clazz.instantialize (this, arguments);
}, org.jmol.adapter.readers.quantum, "JaguarReader", org.jmol.adapter.readers.quantum.MOReader);
...
var sgdata = org.jmol.util.ArrayUtil.createArrayOfArrayList (this.moCount);
var tokens;
...
sdata[iFunc][2] = 0;
sdata[iFunc][3] = 0;
sgdata[iFunc] =  new java.util.ArrayList ();
}var factor = 1;
sgdata[iFunc].add ([this.parseFloatStr (tokens[6]), this.parseFloatStr (tokens[8]) * factor]);
...
var sarray =  new java.util.ArrayList ();
this.gaussianCount = 0;
...
org.jmol.util.Logger.debug (sarray.size () + " slater shells read");
...
lastAtom = tokens[0];
id = tokens[2];
var iType = org.jmol.api.JmolAdapter.getQuantumShellTagID (id);
...
this.moData.put ("gaussians", garray);
if (org.jmol.util.Logger.debugging) {
org.jmol.util.Logger.info (sarray.size () + " slater shells read");
...
function () {
if (!this.haveLine) return Clazz.superCall (this, org.jmol.adapter.readers.quantum.JaguarReader, "readLine", []);
this.haveLine = false;
return this.line;
});
