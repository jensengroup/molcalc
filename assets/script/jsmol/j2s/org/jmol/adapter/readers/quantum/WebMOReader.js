...
Clazz.load (["org.jmol.adapter.readers.quantum.MopacSlaterReader"], "org.jmol.adapter.readers.quantum.WebMOReader", ["java.lang.Boolean", "$.Exception", "$.Float", "java.util.ArrayList", "$.Hashtable", "org.jmol.adapter.smarter.Bond", "org.jmol.api.JmolAdapter", "org.jmol.util.ArrayUtil", "$.Logger"], function () {
c$ = Clazz.declareType (org.jmol.adapter.readers.quantum, "WebMOReader", org.jmol.adapter.readers.quantum.MopacSlaterReader);
...
function () {
Clazz.superCall (this, org.jmol.adapter.readers.quantum.WebMOReader, "finalizeReader", []);
if (this.nOrbitals > 0) this.setMOs ("eV");
if (org.jmol.util.Logger.debugging) org.jmol.util.Logger.debug (this.orbitals.size () + " molecular orbitals read");
});
...
if (atNo == -2147483648) atom.elementSymbol = tokens[0];
 else atom.elementSymbol = org.jmol.adapter.smarter.AtomSetCollectionReader.getElementSymbol (atNo);
...
this.atomSetCollection.addBond ( new org.jmol.adapter.smarter.Bond (atomIndex1 - 1, atomIndex2 - 1, order));
}
});
...
break;
case 5:
isOK = (tokens[0].equals ("DOrbitals") && this.getDFMap (data, org.jmol.api.JmolAdapter.SHELL_D_SPHERICAL, org.jmol.adapter.readers.quantum.WebMOReader.DS_LIST, 99));
break;
case 6:
isOK = (tokens[0].equals ("DOrbitals") && this.getDFMap (data, org.jmol.api.JmolAdapter.SHELL_D_CARTESIAN, org.jmol.adapter.readers.quantum.WebMOReader.DC_LIST, 2));
break;
case 7:
isOK = (tokens[0].equals ("FOrbitals") && this.getDFMap (data, org.jmol.api.JmolAdapter.SHELL_F_SPHERICAL, org.jmol.adapter.readers.quantum.WebMOReader.FS_LIST, 99));
break;
case 10:
isOK = (tokens[0].equals ("FOrbitals") && this.getDFMap (data, org.jmol.api.JmolAdapter.SHELL_F_CARTESIAN, org.jmol.adapter.readers.quantum.WebMOReader.FC_LIST, 3));
break;
}
if (!isOK) {
org.jmol.util.Logger.error ("atomic orbital order is unrecognized -- skipping reading of MOs due to line: " + this.line);
this.orbitals = null;
}}
});
...
var strData = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.readLine ());
...
org.jmol.util.Logger.debug (sdata.size () + " slater shells read");
org.jmol.util.Logger.debug (garray.length + " gaussian primitives read");
...
org.jmol.util.Logger.error ("MOLECULAR ORBITALS SKIPPED");
while (this.getLine ()) {
}
return;
