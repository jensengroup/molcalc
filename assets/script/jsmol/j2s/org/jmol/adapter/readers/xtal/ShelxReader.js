...
}, org.jmol.adapter.readers.xtal, "ShelxReader", org.jmol.adapter.smarter.AtomSetCollectionReader);
...
for (var i = org.jmol.adapter.readers.xtal.ShelxReader.supportedRecordTypes.length; --i >= 0; ) if (command.equals (org.jmol.adapter.readers.xtal.ShelxReader.supportedRecordTypes[i])) {
