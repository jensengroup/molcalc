...
Clazz.load (["org.jmol.adapter.readers.quantum.MopacSlaterReader", "java.util.Hashtable"], "org.jmol.adapter.readers.quantum.CsfReader", ["java.lang.Float", "java.util.ArrayList", "org.jmol.adapter.smarter.Atom", "$.Bond", "org.jmol.api.JmolAdapter", "org.jmol.util.ArrayUtil", "$.Logger", "$.Parser"], function () {
...
}, org.jmol.adapter.readers.quantum, "CsfReader", org.jmol.adapter.readers.quantum.MopacSlaterReader);
...
($fz = function () {
var tokens = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.readLine () + " " + this.readLine () + " " + this.readLine () + " " + this.readLine ());
...
this.readLine ();
this.parseLineParameters (org.jmol.adapter.readers.quantum.CsfReader.connectorFields, org.jmol.adapter.readers.quantum.CsfReader.connectorFieldMap);
...
break;
case 2:
thisAtomID = org.jmol.util.Parser.parseInt (field);
break;
case 4:
...
this.nBonds++;
}, $fz.isPrivate = true, $fz), "org.jmol.adapter.smarter.Bond,~A");
Clazz.defineMethod (c$, "processAtomObject", 
($fz = function () {
this.readLine ();
this.parseLineParameters (org.jmol.adapter.readers.quantum.CsfReader.atomFields, org.jmol.adapter.readers.quantum.CsfReader.atomFieldMap);
this.nAtoms = 0;
...
for (var i = 0; i < this.fieldCount; i++) {
var field = tokens[i];
if (field == null) org.jmol.util.Logger.warn ("field == null in " + this.line);
switch (this.fieldTypes[i]) {
case -1:
atom.atomSerial = org.jmol.util.Parser.parseInt (field);
break;
case 1:
...
($fz = function () {
this.readLine ();
this.parseLineParameters (org.jmol.adapter.readers.quantum.CsfReader.bondFields, org.jmol.adapter.readers.quantum.CsfReader.bondFieldMap);
for (; this.readLine () != null; ) {
if (this.line.startsWith ("property_flags:")) break;
var thisBondID = null;
var tokens = this.getTokens ();
...
if (field.equals ("single")) order = 1;
 ...
 else org.jmol.util.Logger.warn ("unknown CSF bond order: " + field);
var bond =  new org.jmol.adapter.smarter.Bond (-1, -1, 1);
bond.order = order;
...
this.readLine ();
while (this.line != null && this.parseLineParameters (org.jmol.adapter.readers.quantum.CsfReader.vibFields, org.jmol.adapter.readers.quantum.CsfReader.vibFieldMap) > 0) {
...
org.jmol.util.Logger.info ("Reading CSF data for " + this.nOrbitals + " molecular orbitals");
...
this.readLine ();
while (this.line != null && this.parseLineParameters (org.jmol.adapter.readers.quantum.CsfReader.moFields, org.jmol.adapter.readers.quantum.CsfReader.moFieldMap) > 0) while (this.readLine () != null && !this.line.startsWith ("property_flags:")) {
var tokens = this.getTokens ();
for (var i = 0; i < this.fieldCount; ++i) {
switch (this.fieldTypes[i]) {
case -1:
...
($fz = function (sto_gto) {
var atomNos = org.jmol.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.strAtomicNumbers);
...
var zetas = org.jmol.util.ArrayUtil.newFloat2 (this.nOrbitals);
var contractionCoefs = null;
var types =  new Array (this.nOrbitals);
var shells =  Clazz.newIntArray (this.nOrbitals, 0);
var nZetas = 0;
this.readLine ();
while (this.line != null && this.parseLineParameters (org.jmol.adapter.readers.quantum.CsfReader.moFields, org.jmol.adapter.readers.quantum.CsfReader.moFieldMap) > 0) {
...
slater[0] = iAtom;
slater[1] = org.jmol.api.JmolAdapter.getQuantumShellTagID (types[ipt].substring (0, 1));
var nZ = 0;
...
var garray = org.jmol.util.ArrayUtil.newFloat2 (gaussianCount);
