...
($fz = function (key) {
for (var i = org.jmol.adapter.readers.xtal.GulpReader.tags.length; --i >= 0; ) if (org.jmol.adapter.readers.xtal.GulpReader.tags[i].equals (key)) return i;

return -1;
}, $fz.isPrivate = true, $fz), "~S");
Clazz.defineMethod (c$, "setParameter", 
($fz = function (key, value) {
switch (org.jmol.adapter.readers.xtal.GulpReader.parameterIndex (key)) {
case 0:
this.a = value;
break;
case 1:
...
this.setModelParameters (false);
}Clazz.superCall (this, org.jmol.adapter.readers.xtal.GulpReader, "applySymmetryAndSetTrajectory", []);
});
...
c$.tags = c$.prototype.tags = org.jmol.adapter.smarter.AtomSetCollection.notionalUnitcellTags;
});
