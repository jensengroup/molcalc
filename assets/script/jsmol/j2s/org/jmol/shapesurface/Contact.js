...
Clazz.load (["org.jmol.shapesurface.Isosurface", "org.jmol.atomdata.RadiusData", "org.jmol.constant.EnumVdw", "org.jmol.util.Point3f", "$.Vector3f"], "org.jmol.shapesurface.Contact", ["java.lang.Boolean", "$.Double", "$.Float", "java.util.ArrayList", "$.Hashtable", "org.jmol.atomdata.AtomData", "org.jmol.constant.EnumHBondType", "org.jmol.jvxl.data.MeshData", "$.VolumeData", "org.jmol.script.Token", "org.jmol.util.BitSet", "$.BitSetUtil", "$.ColorUtil", "$.ContactPair", "$.Escape", "$.Logger", "$.Measure", "$.MeshSurface"], function () {
...
}, org.jmol.shapesurface, "Contact", org.jmol.shapesurface.Isosurface);
Clazz.prepareFields (c$, function () {
this.vZ =  new org.jmol.util.Vector3f ();
this.vY =  new org.jmol.util.Vector3f ();
this.vX =  new org.jmol.util.Vector3f ();
this.pt1 =  new org.jmol.util.Point3f ();
this.pt2 =  new org.jmol.util.Point3f ();
});
Clazz.defineMethod (c$, "initShape", 
function () {
Clazz.superCall (this, org.jmol.shapesurface.Contact, "initShape", []);
this.myType = "contact";
});
...
org.jmol.util.Logger.info ("Contact intramolecularMode " + intramolecularMode);
org.jmol.util.Logger.info ("Contacts for " + bsA.cardinality () + ": " + org.jmol.util.Escape.escape (bsA));
org.jmol.util.Logger.info ("Contacts to " + bsB.cardinality () + ": " + org.jmol.util.Escape.escape (bsB));
}Clazz.superCall (this, org.jmol.shapesurface.Contact, "setProperty", ["newObject", null, null]);
...
this.thisMesh.bsVdw =  new org.jmol.util.BitSet ();
...
if (colorDensity) {
Clazz.superCall (this, org.jmol.shapesurface.Contact, "setProperty", ["pointSize", Float.$valueOf (ptSize), null]);
} else {
Clazz.superCall (this, org.jmol.shapesurface.Contact, "setProperty", ["token", Integer.$valueOf (1073741964), null]);
...
Clazz.superCall (this, org.jmol.shapesurface.Contact, "setProperty", ["color", Integer.$valueOf (org.jmol.util.ColorUtil.getArgbFromString (defaultColor)), null]);
...
var volumeData =  new org.jmol.jvxl.data.VolumeData ();
var logLevel = org.jmol.util.Logger.getLogLevel ();
...
org.jmol.util.Logger.info ("contact..." + i);
org.jmol.util.Logger.setLogLevel (0);
}if (colorByType) this.setColorByScore ((cp.contactType == 1612189718 ? 4 : cp.score), nV);
}
org.jmol.util.Logger.setLogLevel (logLevel);
return volume;
...
var ad =  new org.jmol.atomdata.AtomData ();
ad.radiusData = rd;
var bs = org.jmol.util.BitSetUtil.copy (bsA);
bs.or (bsB);
...
var vdwA = atomA.getVanderwaalsRadiusFloat (this.viewer, org.jmol.constant.EnumVdw.AUTO);
...
var vdwB = atomB.getVanderwaalsRadiusFloat (this.viewer, org.jmol.constant.EnumVdw.AUTO);
var ra = ad.atomRadius[ia];
var rb = ad.atomRadius[ib];
var d = atomA.distance (atomB);
if (d > ra + rb) continue;
var cp =  new org.jmol.util.ContactPair (this.atoms, ia, ib, ra, rb, vdwA, vdwB);
if (cp.score < 0) org.jmol.shapesurface.Contact.getVdwClashRadius (cp, ra - vdwA, vdwA, vdwB, d);
var typeA = org.jmol.constant.EnumHBondType.getType (atomA);
var typeB = (typeA === org.jmol.constant.EnumHBondType.NOT ? org.jmol.constant.EnumHBondType.NOT : org.jmol.constant.EnumHBondType.getType (atomB));
var isHBond = org.jmol.constant.EnumHBondType.isPossibleHBond (typeA, typeB);
...
for (var m = 0; m < 2; m++) {
for (var p = 0; p < 2; p++) {
switch (org.jmol.shapesurface.Contact.checkCp (cp1, cp2, m, p)) {
case 1:
bsBad.set (i);
break;
case 2:
...
if (org.jmol.util.Logger.debugging) for (var i = 0; i < list.size (); i++) org.jmol.util.Logger.info (list.get (i).toString ());

org.jmol.util.Logger.info ("Contact pairs: " + list.size ());
return list;
}, $fz.isPrivate = true, $fz), "org.jmol.util.BitSet,org.jmol.util.BitSet,org.jmol.atomdata.RadiusData,~N,~B");
...
}, $fz.isPrivate = true, $fz), "org.jmol.util.ContactPair,org.jmol.util.ContactPair,~N,~N");
...
if (isColorDensity) {
Clazz.superCall (this, org.jmol.shapesurface.Contact, "setProperty", ["cutoffRange", [-100.0, 0], null]);
}if (cp == null) {
params.atomRadiusData = rdA;
params.bsIgnore = org.jmol.util.BitSetUtil.copyInvert (bs1, this.atomCount);
...
}, $fz.isPrivate = true, $fz), "~N,org.jmol.util.ContactPair,org.jmol.util.BitSet,org.jmol.util.BitSet,org.jmol.atomdata.RadiusData,~A,~O,~B,org.jmol.jvxl.data.VolumeData,~N");
...
org.jmol.util.Measure.getNormalToLine (this.pt1, this.pt2, this.vZ);
this.vZ.scale (dYZ);
...
}, $fz.isPrivate = true, $fz), "~N,org.jmol.jvxl.data.VolumeData,org.jmol.util.ContactPair,~N,~N");
...
}, $fz.isPrivate = true, $fz), "org.jmol.jvxl.data.MeshData");
...
pairInfo.add (cpInfo);
var cp = list.get (i);
cpInfo.put ("type", org.jmol.script.Token.nameOf (cp.contactType));
